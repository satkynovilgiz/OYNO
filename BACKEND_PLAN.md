...
| Phase | Scope |
|---|---|
| **6a** | Supabase project + environments (dev/staging/prod per §2), `.env.example`, `SupabaseAuthService` swap-in, real email verification + password reset, `profiles`/`user_settings` tables + RLS |
